...
Open [http://localhost:8040](http://localhost:8040) and take a look around.
...
Open [http://localhost:8040?editorial_features=enabled](http://localhost:8040?editorial_features=enabled) and take a look around. This URL flag adds an “Edit” button in the app on every editable piece of content which will take you back to Contentful web app where you can make changes. It also adds “Draft” and “Pending Changes” status indicators to all content if relevant.
...
```bash
docker run -p 8040:8040 -d the-example-app.nodejs
```
